...
### 2.1 Clonació del repositori i feature de l'estructura inicial (Usuari 1)
...
### 2.2 Desenvolupament de les funcionalitats (Usuari 2)
...
### 2.3 Desenvolupament d'estils CSS i Release (Usuari 3)
